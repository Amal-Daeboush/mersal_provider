                            ...
                            children: [
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text('تاريخ الدفع', style: Styles.style5.copyWith(color: AppColors.black)),
                                        Text('رقم الطلب', style: Styles.style5.copyWith(color: AppColors.black)),
                                        Text('العمولة', style: Styles.style5.copyWith(color: AppColors.black)),
                                        Text('المبلغ الصافي', style: Styles.style5.copyWith(color: AppColors.black)),
                                        Text('الحالة', style: Styles.style5.copyWith(color: AppColors.black)),
                                      ],
                                    ),
                                    const Divider(height: 2, color: AppColors.whiteColor2),
                                  ],
                                ),
                              ),
                              ...
                              Expanded(
                                child: ListView.separated(
                                  shrinkWrap: true,
                                  itemBuilder: (context, index) => EarnRow(
                                    earn: controller.earns[index],
                                  ),
                                  separatorBuilder: (context, index) => const Divider(
                                    height: 2,
                                    color: AppColors.whiteColor2,
                                  ),
                                  itemCount: controller.earns.length,
                                ),
                              ),
                              ...
                              const Padding(
                                ...
                                child: ServiceButton(title: 'سحب الأرباح'),
                              ),
                            ],
                          ),
                        ),
